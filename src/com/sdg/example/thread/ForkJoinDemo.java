...
/*
 * http://shengwangi.blogspot.in/2015/10/how-to-use-java-parallel-forkjoin-framework-example.html
*/
public class ForkJoinDemo {
	...
	private static int countLetterUsingForkJoin(char key) {
		int total = 0;
		ForkJoinPool pool = new ForkJoinPool(); // create thread pool for
												// fork/join
...
class CountLetterTask extends RecursiveTask<Integer> {
	...
	protected Integer compute() {
		...
		if (workLoadSize < ACCEPTABLE_SIZE) {
			...
			// System.out.printf("Calculation [%d-%d] in Thread
