...
public class ScheduledPool {
	public static void main(String args[]) {
		...
		final ScheduledFuture beeperHandler = scheduler.scheduleAtFixedRate(new Task("task 1"), 1, 4, SECONDS);

		final ScheduledFuture beeperHandler2 = scheduler.scheduleWithFixedDelay(new Task("task 2"), 1, 4, SECONDS);
