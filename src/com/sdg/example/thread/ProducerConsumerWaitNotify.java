...
public class ProducerConsumerWaitNotify {
	...
	public static class Producer implements Runnable {
		...
		private int maxSize = 10; // maximum number of products which sharedQueue
									// can hold at a time.
		...
		private void produce(int i) throws InterruptedException {
			...
			/*
			 * 2 Synchronized blocks have been used means before producer
			 * produces by entering below synchronized block consumer can
			 * consume.
			 */
